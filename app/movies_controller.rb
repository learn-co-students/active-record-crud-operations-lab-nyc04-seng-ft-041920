...
def can_be_created_in_a_block(args = {title: "Home Alone", release_date: 1990 })
  ...
  # title == "Home Alone"
  # release_date == 1990
  title = args[:title] ? args[:title] : "Home Alone"
  date = args[:release_date] ? args[:release_date] : "1990"
  Movie.create do |m|
    m.title = title 
    m.release_date = date 
  end
...
def can_be_found_updated_and_saved
  ...
  g = Movie.find_by(title: "Awesome Flick")
  g.title = "Even Awesomer Flick"
  g.save 
end
...
def can_update_using_update_method
  ...
  g = Movie.find_by(title: "Wat?")
  g.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  g = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  g.destroy 
end
