...
def can_be_found_updated_and_saved
  ...
  updated_title = Movie.find_by title: 'Awesome Flick'
  updated_title.title = "Even Awesomer Flick"
  updated_title.save
end
...
def can_update_using_update_method
  ...
  updated_title = Movie.find_by title: "Wat?"
  updated_title.update(title: 'Wat, huh?')
end
